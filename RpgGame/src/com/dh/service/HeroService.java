...
public class HeroService {
	...
	public void deletePlayerHero(PlayerHeroVO playerHeroVO) throws Exception {
		...
		sqlSaveThread.putSql(playerHeroVO.getPlayerId(),sqlBuild.getSql("com.dh.dao.PlayerHeroMapper.deletePlayerHero", playerHeroVO));
	}
	...
	private void addPlayerHero(PlayerHeroVO playerHeroVO) throws Exception {
		...
		sqlSaveThread.putSql(playerHeroVO.getPlayerId(),sqlBuild.getSql("com.dh.dao.PlayerHeroMapper.addPlayerHero", playerHeroVO));
	}
