...
public class WelfareService {
	...
	public List<PlayerOpenActVO> getPlayerOpenActVO() {
		return welfareMapper.getPlayerOpenActVO();
	}

	public void insertPlayerOpenActVO(PlayerOpenActVO playerOpenActVO) {
		OpenActConstants.addPlayerOpenActVO(playerOpenActVO);
		sqlSaveThread.putSql(playerOpenActVO.getPlayerId(), sqlBuild.getSql("com.dh.dao.WelfareMapper.insertPlayerOpenActVO", playerOpenActVO));
	}
	
	public void updatePlayerOpenActVO(PlayerOpenActVO playerOpenActVO) {
		sqlSaveThread.putSql(playerOpenActVO.getPlayerId(), sqlBuild.getSql("com.dh.dao.WelfareMapper.updatePlayerOpenActVO", playerOpenActVO));
	}
