...
public class BaseInfoService {
	...
	public void loadActivity() {
		...
		OpenActConstants.setOpenActList(welfareMapper.getPlayerOpenActVO());
	}

	public void loadGameRecord() throws Exception {
		GameRecordConstants.GAMERECORDLIST = baseInfoMapper.getGameRecordVOList();
		GameRecordConstants.TENZAOMU_VALUE.set(GameRecordConstants.getGameRecordVO(GameRecordConstants.TENZAOMU).getValue1());// 求贤若渴
		// 全服十连抽达到500次
		GameRecordConstants.JJCTZ_VALUE.set(GameRecordConstants.getGameRecordVO(GameRecordConstants.JJCTZ).getValue1());// 身经百战
		// 全服竞技场挑战达到1000次
		GameRecordConstants.ENHANCE_VALUE.set(GameRecordConstants.getGameRecordVO(GameRecordConstants.ENHANCE).getValue1());// 千锤百炼
		// 全服装备强化达到1000次
		GameRecordConstants.HEROUPLEVEL_VALUE.set(GameRecordConstants.getGameRecordVO(GameRecordConstants.HEROUPLEVEL).getValue1());// 突飞猛进
		// 全服英雄升级达到1000次
		GameRecordConstants.VIP1NUM_VALUE.set(GameRecordConstants.getGameRecordVO(GameRecordConstants.VIP1NUM).getValue1());// 人杰地灵
		// vip1数量达到200个
		GameRecordConstants.VIP4NUM_VALUE.set(GameRecordConstants.getGameRecordVO(GameRecordConstants.VIP4NUM).getValue1());// 钟灵毓秀
		// vip4数量达到50个
		GameRecordConstants.VIP7NUM_VALUE.set(GameRecordConstants.getGameRecordVO(GameRecordConstants.VIP7NUM).getValue1());// 卧虎藏龙
		// vip7数量达到30个
		GameRecordConstants.VIP8NUM_VALUE.set(GameRecordConstants.getGameRecordVO(GameRecordConstants.VIP8NUM).getValue1());// 群英荟萃
		// vip8数量达到20个
		GameRecordConstants.VIP9NUM_VALUE.set(GameRecordConstants.getGameRecordVO(GameRecordConstants.VIP9NUM).getValue1());// 鸾翔凤集
		// vip9数量达到20个
		GameRecordConstants.VIP10NUM_VALUE.set(GameRecordConstants.getGameRecordVO(GameRecordConstants.VIP10NUM).getValue1());// 国士无双
		// vip10数量达到20个
		...
		gameRecordVO = GameRecordConstants.getGameRecordVO(GameRecordConstants.VIP1NUM);
		GameRecordConstants.VIP1NUM_VALUE.set(gameRecordVO.getValue1());// 人杰地灵
																		// vip1数量达到200个
		GameRecordConstants.WALFARELIST.add(gameRecordVO);

		gameRecordVO = GameRecordConstants.getGameRecordVO(GameRecordConstants.VIP4NUM);
		GameRecordConstants.VIP4NUM_VALUE.set(gameRecordVO.getValue1());// 钟灵毓秀
																		// vip4数量达到50个
		GameRecordConstants.WALFARELIST.add(gameRecordVO);

		gameRecordVO = GameRecordConstants.getGameRecordVO(GameRecordConstants.VIP7NUM);
		GameRecordConstants.VIP7NUM_VALUE.set(gameRecordVO.getValue1());// 卧虎藏龙
																		// vip7数量达到30个
		GameRecordConstants.WALFARELIST.add(gameRecordVO);

		gameRecordVO = GameRecordConstants.getGameRecordVO(GameRecordConstants.VIP8NUM);
		GameRecordConstants.VIP8NUM_VALUE.set(gameRecordVO.getValue1());// 群英荟萃
																		// vip8数量达到20个
		GameRecordConstants.WALFARELIST.add(gameRecordVO);

		gameRecordVO = GameRecordConstants.getGameRecordVO(GameRecordConstants.VIP9NUM);
		GameRecordConstants.VIP9NUM_VALUE.set(gameRecordVO.getValue1());// 鸾翔凤集
																		// vip9数量达到20个
		GameRecordConstants.WALFARELIST.add(gameRecordVO);

		gameRecordVO = GameRecordConstants.getGameRecordVO(GameRecordConstants.VIP10NUM);
		...
		gameRecordVO = GameRecordConstants.getGameRecordVO(GameRecordConstants.OPENSERVERTIME); // 开服时间
		GameRecordConstants.LOPENSERVERTIME = DateUtil.str2Date(gameRecordVO.getStrv1(), DateUtil.DAY_FORMAT_STRING).getTime();
	...
	public void reloadCSV(String name) {
		...
		OpenActRes.getInstance().reLoadFile(OpenActRes.Path, name);
