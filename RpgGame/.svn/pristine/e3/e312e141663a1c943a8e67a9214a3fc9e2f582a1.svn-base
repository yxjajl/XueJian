...
public class ShopService {
	...
	public void insertPlayerShop(PlayerShopVO PlayerShopVO) throws Exception {
		sqlSaveThread.putSql(PlayerShopVO.getPlayerId(), sqlBuild.getSql("com.dh.dao.PlayerShopMapper.delPlayerShop", PlayerShopVO));
		sqlSaveThread.putSql(PlayerShopVO.getPlayerId(), sqlBuild.getSql("com.dh.dao.PlayerShopMapper.insertPlayerShop", PlayerShopVO));
	}
	...
	public void deleteAllPlayerShop() {
		sqlSaveThread.putSql(0, sqlBuild.getSql("com.dh.dao.PlayerShopMapper.deleteAllPlayerShop", DateUtil.formatDate(new Date(), DateUtil.DAY_FORMAT_STRING)));
	}
